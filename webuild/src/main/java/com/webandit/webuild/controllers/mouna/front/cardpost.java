...
public class cardpost {
    ...
    public void comment(ActionEvent actionEvent) throws IOException, SQLException {
        ...
        if (post != null && post.getId() != 0) {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/forum/gridcommentaire.fxml"));
    ...
    public void onEditButtonClickFront(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/forum/editcomment.fxml"));
