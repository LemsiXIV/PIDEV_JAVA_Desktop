   ...
   private String selectedAssuranceName;
    ...
    private void actualise() throws SQLException {
        ...
        for (Assurance assurance : assurances) {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/Assurance/cardAssu.fxml"));
    ...
    void addchoice(ActionEvent event) throws IOException {
        ...
        if (selectedAssuranceName != null) {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/Assurance/demandefront.fxml"));
