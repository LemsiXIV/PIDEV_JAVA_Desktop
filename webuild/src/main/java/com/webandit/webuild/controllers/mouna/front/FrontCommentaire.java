...
public class FrontCommentaire {
    ...
    public void actualise() throws SQLException {
        ...
        for (Commentaire commentaire : commentaires) {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/forum/commentfront.fxml"));
    ...
    public void addcommentairefront(ActionEvent actionEvent) throws IOException, SQLException {
      FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/forum/zydcomment.fxml"));
